...
1. 绘制多点
   ...
   ![image-20200922151301533](/assets/img/graphical/160100182512449684509406393196.png)

2. 如果是线，就连点成线

   ![image-20200922153449307](/assets/img/graphical/160100182512418118397651113116.png)

3. 如果是面，那就在图形内部，逐片元填色

   ![image-20200922153643189](/assets/img/graphical/16010018251245556671029480402.png)
...
![image-160100182512404500215449783007](/assets/img/graphical/160100182512404500215449783007.png)

### 2-绘制多点详解

顶点数据 -> 着色器 -> 顶点数据绘图

在js中建立顶点数据，着色器肯定是拿不到的，这是语言不通导致的。
...
。因为咱们缓冲区里的顶点数据是数组，里面有多个顶点所以我们得开启一个让着色器批量处理顶点数据的属性。默认着色器只会一个一个的接收顶点数据，然后一个一个的绘制顶点。
...
1. 顶点着色器中的gl_PointSize = 20.0 不要，因为这个属性是控制顶点大小
...
![image-20200924113247043](/assets/img/graphical/160100182512428613629945237906.png)

webgl 可以画面，也可以在gl.drawArrays() 方法的第一个参数里进行其他设置。
...
![image-20200927115202967](/assets/img/graphical/image-20200927115202967.png)
...
![image-20200927112630534](/assets/img/graphical/image-20200927112630534.png)
...
![image-20200927113956696](/assets/img/graphical/image-20200927113956696.png)

​上面线条的绘制顺序是：v0>v1>v2>v3>v4>v5

3. LINE_LOOP 闭合线条

![image-20200927114345495](/assets/img/graphical/image-20200927114345495.png)
...
![image-20200927161356266](/assets/img/graphical/image-20200927161356266.png)
...
![image-20200930230050526](/assets/img/graphical/image-20200930230050526.png)
...
![image-20200927160758122](/assets/img/graphical/image-20200927160758122.png)
...
![image-20200930220329539](/assets/img/graphical/image-20200930220329539.png)
...
![image-20200930223815832](/assets/img/graphical/image-20200930223815832.png)
...
![image-20200930223654798](/assets/img/graphical/image-20200930223654798.png)
...
![image-20200930230452532](/assets/img/graphical/image-20200930230452532.png)
...
![image-20210306161928219](/assets/img/graphical/image-20210306161928219.png)

2.一秒钟后，在左下角画一个点

![image-20210306162145896](/assets/img/graphical/image-20210306162145896.png)

3.两秒钟后，我再画一条线段

![image-20210306162351559](/assets/img/graphical/image-20210306162351559.png)
...
![image-20210312161835601](/assets/img/graphical/image-20210312161835601.png)
...
![image-20210312161129484](/assets/img/graphical/image-20210312161129484.png)



适合TRIANGLE_FAN三角扇的模型：

![image-20210312161335598](/assets/img/graphical/image-20210312161335598.png)
...
![image-20210311153236165](/assets/img/graphical/image-20210311153236165.png)
...
![16109600591457223186999880544](/assets/img/graphical/16109600591457223186999880544.png)

已知：逆时针绘图的路径G

求：将其变成下方网格的方法

![16109600591456188731865428303](/assets/img/graphical/16109600591456188731865428303.png)
...
![image-20210314082945506](/assets/img/graphical/image-20210314082945506.png)
...
![image-20210314084138562](/assets/img/graphical/image-20210314084138562.png)
...
![image-20210314095034861](/assets/img/graphical/image-20210314095034861.png)
